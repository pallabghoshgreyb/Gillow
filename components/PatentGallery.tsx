      ...
      <div className="relative h-[500px] w-full bg-slate-100 rounded-3xl overflow-hidden border border-slate-200 shadow-inner group">
        ...
        <div className="absolute inset-0 flex items-center justify-between px-6 opacity-0 group-hover:opacity-100 transition-opacity">
          <button 
            ...
            className="w-12 h-12 bg-white/90 backdrop-blur rounded-full shadow-xl flex items-center justify-center text-slate-700 hover:bg-[#00bdcd] hover:text-white transition-all active:scale-90"
          >
            <ChevronLeft size={24} />
          </button>
          <button 
        ...
        <button className="absolute bottom-6 right-6 p-3 bg-white/90 backdrop-blur rounded-xl shadow-lg text-slate-500 hover:text-[#00bdcd] transition-all">
          <Maximize2 size={20} />
        </button>
      </div>
