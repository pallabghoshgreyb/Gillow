      ...
      <div className="bg-white w-full max-w-md rounded-xl shadow-2xl border border-slate-200 overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="p-6 space-y-4">
            <p className="text-sm text-slate-600">
                Enter your FastAPI server URL (e.g., <code>http://localhost:8000</code>). The app will automatically connect to your PostgreSQL database through the PatIndex API.
            </p>
