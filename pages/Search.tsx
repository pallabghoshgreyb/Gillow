...
const Search: React.FC = () => {
  ...
  const handlePatentClick = (id: string) => navigate(`/patent/${id}`);
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-80px)] bg-white overflow-hidden font-sans">
                ...
                <div className="flex items-center justify-between mb-8">
                    <div>
                        <h2 className="text-2xl font-black text-slate-900 tracking-tight">
                           {query ? `Search: "${query}"` : 'Marketplace Hub'}
                        </h2>
                ...
                {loading ? (
                    ...
                    <div className="h-[75vh] rounded-[2rem] overflow-hidden border border-slate-200 shadow-2xl bg-white animate-in zoom-in-95 duration-700">
                        <PatentMap 
                            ...
                            onSelectPatent={(p) => handlePatentClick(p.id)} 
                        />
                    </div>
                        ...
                        {filteredPatents.map(patent => (
                            <div key={patent.id} className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                                <PatentCard 
                                    ...
                                    onClick={(id) => handlePatentClick(id)}
      ...
      <SaveSearchModal 
        ...
        onSave={onSaveSearch}
        currentFiltersCount={filters.categories.length + filters.statuses.length}
      />
