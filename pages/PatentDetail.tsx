...
const PatentDetail: React.FC = () => {
  ...
  const operationalStatusBadgeClass = isInactiveStatus
        ...
        <div className="lg:col-span-8 space-y-20">
            ...
            <section id="header" className="space-y-10">
                <div className="flex flex-col gap-6">
                    <div className="flex items-center gap-3">
                        ...
                        <span className={`px-3 py-1 text-[10px] font-black uppercase tracking-widest rounded-lg border flex items-center gap-1.5 ${operationalStatusBadgeClass}`}>
                            <CheckCircle2 size={12} /> {operationalStatus}
                        </span>
            ...
            {hasLegalProfile && <section id="legal-profile" className="space-y-8">
                 <div className="flex items-center justify-between">
                    ...
                    {hasText(patent.simpleLegalStatus) && <div className={`px-4 py-1.5 rounded-full text-xs font-black uppercase tracking-widest flex items-center gap-2 border ${operationalStatusBadgeClass}`}>
                        {isInactiveStatus ? <XCircle size={14} /> : <BadgeCheck size={14} />}
