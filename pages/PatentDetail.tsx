      ...
      <div className="sticky top-20 z-40 bg-white/95 backdrop-blur-md border-b border-slate-100 py-3 px-6 shadow-sm">
          <div className="max-w-[1400px] mx-auto flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                  ...
                  <button className="p-2.5 rounded-xl border border-slate-200 text-slate-600 hover:bg-slate-50 shadow-sm"><Share2 size={18} /></button>
                  <button className="p-2.5 rounded-xl border border-slate-200 text-slate-600 hover:bg-slate-50 shadow-sm"><Download size={18} /></button>
              </div>
          </div>
      </div>
