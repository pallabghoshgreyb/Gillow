  ...
  return (
    <div className="min-h-[80vh] flex flex-col items-center justify-center px-6 text-center bg-white">
      <div className="relative mb-12 animate-in zoom-in duration-700">
        <div className="select-none text-[180px] font-semibold leading-none text-slate-50">404</div>
      ...
      <h1 className="mb-6 text-4xl font-semibold tracking-tight text-slate-900">Endpoint Not Found</h1>
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <button 
          onClick={() => navigate('/')}
          className="flex items-center justify-center gap-2 rounded-2xl bg-slate-900 px-8 py-4 font-semibold text-white transition-all hover:bg-slate-800 active:scale-95"
        >
